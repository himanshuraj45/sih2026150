...
const SITE_TITLE = "NEXORA — AI-Assisted CCTV Forensic Intelligence Platform";
const SITE_DESCRIPTION = "NEXORA is an AI-assisted CCTV forensic intelligence platform for monitoring camera feeds, investigating incidents, and connecting visual evidence with live geospatial intelligence.";
...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    // CCTV and forensic intelligence platform
    "CCTV forensic intelligence", "AI-assisted CCTV analysis", "video intelligence platform", "incident investigation",
    "geospatial intelligence", "real-time tracking", "intelligence dashboard",
    ...
    // Brand
    "NEXORA", "NEXORA CCTV", "NEXORA intelligence platform",
  ],
  ...
  openGraph: {
    title: "NEXORA — AI-Assisted CCTV Forensic Intelligence Platform",
    description: SITE_DESCRIPTION,
    type: "website",
    siteName: SITE_NAME,
    locale: "en_US",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "NEXORA — AI-Assisted CCTV Forensic Intelligence Platform",
        type: "image/png",
      },
    ],
  },
  ...
  other: {
    ...
    "apple-mobile-web-app-title": "NEXORA",
...
const jsonLd = {
  ...
  "@type": "WebApplication",
  name: "NEXORA — AI-Assisted CCTV Forensic Intelligence Platform",
  alternateName: ["NEXORA", "NEXORA CCTV", "NEXORA Forensic Intelligence"],
  url: SITE_URL,
  description: SITE_DESCRIPTION,
