...
import { Layers, BarChart3, Newspaper, Search, X, Globe, MapPinned, Route, Radar, Satellite, Moon, ExternalLink, AlertTriangle, Activity, Database, Wifi, Play, Network, Crosshair, Bluetooth, Pentagon, Radio, PenLine, Video } from 'lucide-react';
      ...
      <AnimatePresence>
        {showSplash && (
          ...
          >
            ...
            {/* ── NEXORA title — letter-by-letter stagger ── */}
            ...
            <div className="overflow-hidden mb-8 z-[2]">
              ...
              >
                <p className="text-[11px] md:text-[10px] font-mono tracking-[0.5em] text-[var(--gold-primary)]" style={{ opacity: 0.8 }}>
                  AI-ASSISTED CCTV FORENSIC INTELLIGENCE PLATFORM
                </p>
              </motion.div>
            </div>
      ...
      <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, delay: 2.5 }} className={`absolute top-4 z-[200] pointer-events-none flex flex-col`} style={{ left: isMobile ? '24px' : '64px', right: '24px' }}>
        <div className="flex items-center gap-3 w-fit">
          ...
          <div className="flex flex-col items-start gap-0.5">
            <h1 className="text-lg md:text-xl font-bold tracking-[0.4em] text-[#D4AF37] font-mono">NEXORA</h1>
            <span className="text-[9px] md:text-[10px] font-mono tracking-[0.2em] opacity-80 uppercase text-[#D4AF37]">AI-ASSISTED CCTV FORENSIC INTELLIGENCE PLATFORM</span>
          </div>
          <a href="/forensics" className="pointer-events-auto hidden items-center gap-2 border border-[var(--border-cyan)] bg-[var(--bg-panel)] px-3 py-2 text-[9px] font-mono tracking-[0.16em] text-[var(--cyan-primary)] transition-colors hover:border-[var(--cyan-primary)] md:inline-flex" title="Open CCTV forensic analysis">
        ...
        <>
          ...
          <div className="mobile-nav">
            <div className="glass-panel mobile-nav-inner">
              <a href="/forensics" className="mobile-nav-btn" aria-label="Open CCTV forensic analysis">
                <Video className="h-4 w-4 text-[var(--cyan-primary)]" />
                <span className="text-[var(--cyan-primary)]">FORENSICS</span>
              </a>
              {[
